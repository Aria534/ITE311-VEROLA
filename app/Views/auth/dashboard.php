  ...
  <div class="col-md-3 mb-4">
    <div class="card text-center shadow-sm border-0 h-100">
      <div class="card-body">
        ...
        <p class="text-muted small">Find and enroll in available courses.</p>
        <div class="d-grid gap-2">
          <a href="#availableList" class="btn btn-outline-success btn-sm">Enroll Now</a>
        </div>
      </div>
    </div>
  </div>
        ...
        if (response.status === 'success') {
          $('#alertPlaceholder').html(`
            <div class="alert alert-success alert-dismissible fade show mt-3" role="alert">
              Successfully enrolled in <strong>${response.data.course.title}</strong>!
